...
// SearchHistoriesDao 搜索历史表的Dao实现
type SearchHistoriesDao struct {
	*gorm.DB
}

func (dao *SearchHistoriesDao) Database() string {
	// TODO 补全 db 名称
	return "@database_name"
}

// NewSearchHistoriesDao 创建SearchHistoriesDao实例
// 参数:
//   - db: GORM数据库连接实例
//
// 返回:
//   - *SearchHistoriesDao: Dao实例
func NewSearchHistoriesDao(db *gorm.DB) *SearchHistoriesDao {
	return &SearchHistoriesDao{DB: db}
}
...
//
// 返回:
//   - *SearchHistoriesDao: 使用事务的新 DAO 实例
//
// 使用示例:
//
...
//	})
func (dao *SearchHistoriesDao) WithTx(tx *gorm.DB) *SearchHistoriesDao {
	return &SearchHistoriesDao{DB: tx}
}
...
// 使用示例:
//
//	err := dao.Transaction(ctx, func(txDao *SearchHistoriesDao) error {
...
//	    return nil
//	})
func (dao *SearchHistoriesDao) Transaction(ctx context.Context, fn func(*SearchHistoriesDao) error) error {
	return dao.WithContext(ctx).Transaction(func(tx *gorm.DB) error {
		txDao := &SearchHistoriesDao{DB: tx}
		return fn(txDao)
	})
}
...
// buildSearchHistoriesQueryCondition 构建查询条件
// 参数:
//   - db: GORM数据库连接实例
//   - queryDto: 查询条件Dto对象
//
...
func (dao *SearchHistoriesDao) buildSearchHistoriesQueryCondition(db *gorm.DB, queryDto *query.SearchHistoriesDto) (*gorm.DB, error) {
	if queryDto == nil {
		return db, nil
	}
	...
	if queryDto.Keyword != "" {
		db = db.Where("keyword = ?", queryDto.Keyword)
	}
	...
	// 模糊查询条件
	if queryDto.KeywordFuzzy != "" {
		db = db.Where("keyword LIKE ?", "%"+queryDto.KeywordFuzzy+"%")
	}
...
//     2. List 不为 nil 且长度 > 0: 添加 IN 查询条件
//     3. List 不为 nil 但长度 = 0: 返回错误，因为空列表的 IN 查询没有意义，应提前发现此问题
func (dao *SearchHistoriesDao) SelectList(ctx context.Context, queryDto *query.SearchHistoriesDto) ([]*model.SearchHistories, error) {
	var resultList []*model.SearchHistories
	db := dao.WithContext(ctx).Model(&model.SearchHistories{})

	// 应用查询条件
	var err error
	db, err = dao.buildSearchHistoriesQueryCondition(db, queryDto)
	if err != nil {
		return nil, err
	}
...
//     2. List 不为 nil 且长度 > 0: 添加 IN 查询条件
//     3. List 不为 nil 但长度 = 0: 返回错误，因为空列表的 IN 查询没有意义，应提前发现此问题
func (dao *SearchHistoriesDao) SelectCount(ctx context.Context, queryDto *query.SearchHistoriesDto) (int64, error) {
	var count int64
	db := dao.WithContext(ctx).Model(&model.SearchHistories{})
...
func (dao *SearchHistoriesDao) SelectListWithAppendConditionFunc(ctx context.Context, queryDto *query.SearchHistoriesDto, appendConditionFunc func(ctx context.Context, db *gorm.DB) *gorm.DB) ([]*model.SearchHistories, error) {
	var resultList []*model.SearchHistories
	db := dao.WithContext(ctx).Model(&model.SearchHistories{})
...
func (dao *SearchHistoriesDao) SelectCountWithAppendConditionFunc(ctx context.Context, queryDto *query.SearchHistoriesDto, appendConditionFunc func(ctx context.Context, db *gorm.DB) *gorm.DB) (int64, error) {
	var count int64
	db := dao.WithContext(ctx).Model(&model.SearchHistories{})
...
func (dao *SearchHistoriesDao) Insert(ctx context.Context, poBean *model.SearchHistories) error {
	if poBean == nil {
...
func (dao *SearchHistoriesDao) InsertBatch(ctx context.Context, poBeanList []*model.SearchHistories) error {
	if len(poBeanList) == 0 {
...
func (dao *SearchHistoriesDao) InsertOrUpdateNullable(ctx context.Context, poBean *model.SearchHistories) error {
	if poBean == nil {
...
func (dao *SearchHistoriesDao) InsertOrUpdateBatchNullable(ctx context.Context, poBeanList []*model.SearchHistories) error {
	if len(poBeanList) == 0 {
...
// 说明:
//   - 该索引不是唯一索引，可能返回多条记录
func (dao *SearchHistoriesDao) SelectByUserId(ctx context.Context, userId uint64) ([]*model.SearchHistories, error) {
	var resultList []*model.SearchHistories
...
//   - [] *model.SearchHistories: 查询结果列表
//   - error: 错误信息
func (dao *SearchHistoriesDao) SelectByUserIdList(ctx context.Context, userIdList []uint64) ([]*model.SearchHistories, error) {
	if len(userIdList) == 0 {
		return []*model.SearchHistories{}, nil
	}
	var resultList []*model.SearchHistories
...
func (dao *SearchHistoriesDao) UpdateByUserId(ctx context.Context, poBean *model.SearchHistories, userId uint64) error {
	if poBean == nil {
		return fmt.Errorf("更新对象不能为空")
	}
	return dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("user_id = ?", userId).Updates(poBean).Error
}
...
//   - 注意: 该索引不是唯一键，可能会更新多条记录
func (dao *SearchHistoriesDao) UpdateByUserIdWithMap(ctx context.Context, userId uint64, updatedMap map[string]interface{}) error {
	if len(updatedMap) == 0 {
		return fmt.Errorf("更新字段不能为空")
	}
	return dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("user_id = ?", userId).Updates(updatedMap).Error
}
...
//   - 注意: 可能会更新多条记录
func (dao *SearchHistoriesDao) UpdateByUserIdWithCondition(ctx context.Context, poBean *model.SearchHistories, userId uint64, conditionMap map[string]interface{}) error {
	if poBean == nil {
		return fmt.Errorf("更新对象不能为空")
	}
	db := dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("user_id = ?", userId)
...
//   - 使用 map 可以显式指定要更新的字段，包括零值字段
//   - 提供最灵活的更新控制方式
func (dao *SearchHistoriesDao) UpdateByUserIdWithMapAndCondition(ctx context.Context, userId uint64, updatedMap map[string]interface{}, conditionMap map[string]interface{}) error {
	if len(updatedMap) == 0 {
		return fmt.Errorf("更新字段不能为空")
	}
	db := dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("user_id = ?", userId)
...
func (dao *SearchHistoriesDao) DeleteByUserId(ctx context.Context, userId uint64) error {
	return dao.WithContext(ctx).Where("user_id = ?", userId).Delete(&model.SearchHistories{}).Error
}
...
// 说明:
//   - 该索引不是唯一索引，可能返回多条记录
func (dao *SearchHistoriesDao) SelectByCreatedAt(ctx context.Context, createdAt *time.Time) ([]*model.SearchHistories, error) {
	var resultList []*model.SearchHistories
...
//   - [] *model.SearchHistories: 查询结果列表
//   - error: 错误信息
func (dao *SearchHistoriesDao) SelectByCreatedAtList(ctx context.Context, createdAtList []*time.Time) ([]*model.SearchHistories, error) {
...
//   - 只更新非零值字段，零值字段会被忽略
//   - 注意: 该索引不是唯一键，可能会更新多条记录
func (dao *SearchHistoriesDao) UpdateByCreatedAt(ctx context.Context, poBean *model.SearchHistories, createdAt *time.Time) error {
	if poBean == nil {
		return fmt.Errorf("更新对象不能为空")
	}
	return dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("created_at = ?", createdAt).Updates(poBean).Error
}
...
//   - 只更新 map 中指定的字段，未指定的字段保持不变
//   - 注意: 该索引不是唯一键，可能会更新多条记录
func (dao *SearchHistoriesDao) UpdateByCreatedAtWithMap(ctx context.Context, createdAt *time.Time, updatedMap map[string]interface{}) error {
	if len(updatedMap) == 0 {
		return fmt.Errorf("更新字段不能为空")
	}
	return dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("created_at = ?", createdAt).Updates(updatedMap).Error
}
...
//   - 适用场景: 需要在索引基础上增加额外的更新条件，缩小更新范围
//   - 注意: 可能会更新多条记录
func (dao *SearchHistoriesDao) UpdateByCreatedAtWithCondition(ctx context.Context, poBean *model.SearchHistories, createdAt *time.Time, conditionMap map[string]interface{}) error {
	if poBean == nil {
		return fmt.Errorf("更新对象不能为空")
	}
	db := dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("created_at = ?", createdAt)
...
//   - 使用 map 可以显式指定要更新的字段，包括零值字段
//   - 提供最灵活的更新控制方式
func (dao *SearchHistoriesDao) UpdateByCreatedAtWithMapAndCondition(ctx context.Context, createdAt *time.Time, updatedMap map[string]interface{}, conditionMap map[string]interface{}) error {
	if len(updatedMap) == 0 {
		return fmt.Errorf("更新字段不能为空")
	}
	db := dao.WithContext(ctx).Model(&model.SearchHistories{}).Where("created_at = ?", createdAt)
...
// 说明:
//   - 注意: 该索引不是唯一键，可能会删除多条记录
func (dao *SearchHistoriesDao) DeleteByCreatedAt(ctx context.Context, createdAt *time.Time) error {
	return dao.WithContext(ctx).Where("created_at = ?", createdAt).Delete(&model.SearchHistories{}).Error
}
...
//
//	// 示例1: 查询单条记录
//	var result entity.SearchHistories
//	err := dao.ExecSql(ctx, &result, "SELECT * FROM search_histories WHERE id = ?", 1)
//	if err != nil {
//	    // 处理错误（包括记录不存在的情况）
//	    return err
//	}
//
//	// 示例2: 查询多条记录
//	var resultList [] *entity.SearchHistories
//	err := dao.ExecSql(ctx, &resultList, "SELECT * FROM search_histories WHERE skill_id = ?", "skill123")
//	if err != nil {
//	    return err
//	}
//
...
//	err := dao.ExecSql(ctx, &countList, "SELECT skill_id, COUNT(*) as count FROM search_histories GROUP BY skill_id")
//
// 注意事项:
...
func (dao *SearchHistoriesDao) ExecSql(ctx context.Context, recvPtr any, sql string, args ...any) error {
...
func (dao *SearchHistoriesDao) getValidOrderByFields() map[string]bool {
...
func (dao *SearchHistoriesDao) isValidOrderBy(orderBy string) bool {
	if orderBy == "" {
		return false
	}
